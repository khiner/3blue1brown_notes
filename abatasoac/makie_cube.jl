...
# ╔═╡ a4a1a1ea-878f-11ec-08c3-9b1f45bdd409
using GLMakie, GeometryBasics

# ╔═╡ cebb5e80-caed-431d-96ef-98450dfe670a
function plot_cube(face_colors=[:red :green :blue :orange :purple :yellow])
	cube = Rect3f([0.0, 0.0, 0.0], [1.0, 1.0, 1.0])
	m = GeometryBasics.mesh(cube)
	quad_faces = faces(cube)
	triangle_faces = decompose(GLTriangleFace, cube)
	points = decompose(Point3f, cube)
	Makie.poly(m;
		color=reshape(repeat(face_colors, 4), :),
	)
end

# ╔═╡ 5ee86e6f-9a34-4e5c-9b9a-0f72f079e5f2
plot_cube()
